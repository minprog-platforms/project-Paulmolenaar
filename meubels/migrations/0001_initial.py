# Generated by Django 3.1.3 on 2022-05-24 19:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorie', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat_product', to='meubels.categorie')),
            ],
        ),
        migrations.CreateModel(
            name='KamerAfmetingen',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('afmeting_breedte', models.IntegerField()),
                ('afmeting_lengte', models.IntegerField()),
                ('afmeting_hoogte', models.IntegerField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='afmetingen_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Bestellingen',
            fields=[
                ...
                ('prijs_totaal', models.FloatField()),
                ('afgerond', models.BooleanField()),
                ('datum_afgerond', models.DateTimeField()),
                ('producten', models.ManyToManyField(blank=True, to='meubels.Producten')),
